...
class App:
    ...
    def _create_layout(self):
        return [
            ...
            [
                sg.Button("7", size=(7, 2)),
                sg.Button("8", size=(7, 2)),
                sg.Button("9", size=(7, 2)),
                sg.Button("/", size=(7, 2)),
            ],
            [
                sg.Button("4", size=(7, 2)),
                sg.Button("5", size=(7, 2)),
                sg.Button("6", size=(7, 2)),
                sg.Button("*", size=(7, 2)),
            ],
            [
                sg.Button("1", size=(7, 2)),
                sg.Button("2", size=(7, 2)),
                sg.Button("3", size=(7, 2)),
                sg.Button("-", size=(7, 2)),
            ],
            [
                sg.Button(".", size=(7, 2)),
                sg.Button("0", size=(7, 2)),
                sg.Button("=", size=(7, 2)),
                sg.Button("+", size=(7, 2)),
            ],
        ]
