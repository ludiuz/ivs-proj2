...
label_resoult = Label(bd=0, bg="#fcfcfc", textvariable=form.res, highlightthickness=0)
...
entry1 = Entry(
    justify="right", bd=0, bg="#fcfcfc", textvariable=form._inp, highlightthickness=0
)

entry1.place(x=15, y=85, width=330, height=103)

entry1.bind("<Key>", form.on_key_press)
